...
- `permissions/permissions` предоставляет таблицу управления атомарными доступами: здесь можно создать или отредактировать доступ, и увидеть, каким пользователям он присвоен.
